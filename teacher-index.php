...
// Include -header.php for session checks and database setup
include 'teacher-header.php';

// Check if user is logged in and is a 
if (!isset($_SESSION['loggedin']) || !isset($_SESSION['teacher'])) {
    header('Location: index.php'); // Redirect if not logged in or not a 
    exit;
}
