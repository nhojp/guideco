...
$sql_complaints = "SELECT * FROM complaints_student WHERE id = $id"; // Adjust table name and column names as per your database structure
...
$result_admin = $conn->query(ucwords($sql_admin));
...
<body>
    <div class="container">
        ...
        <table class="table-form">
            <tr>
                <td class="text-left font-weight-bold">
                    <p class="ml-4">C. STUDENT COMPLAINED OF</p>
                </td>
            </tr>
        </table>
        ...
        <table class="table-form">
            <tbody>
                <tr>
                    <th>
                    <td>
                        <p style="margin-left: 45px;"> Gr./Yr. and Section: <u><?php echo ucwords(htmlspecialchars($complaint['complainedGrade'] . ' - ' . $complaint['complainedSection'])); ?></u>
                        </p>
                    </td>
                    </th>
                    <th>
                    <td>
                        <p> Adviser: <u><?php echo ucwords(htmlspecialchars($complaint['complainedAdviser'])); ?></u>
                        </p>
                    </td>
                    </th>
                </tr>
        ...
        <table class="table-form">
            <tr>
                <td>
                    <p style="margin-left: 65px;"> Mother: <u><?php echo ucwords(htmlspecialchars($complaint['complainedMotherName'])); ?></u></p>
                </td>
            </tr>
            <tr>
                <td>
                    <p style="margin-left: 65px;"> Occupation: <u><?php echo ucwords(htmlspecialchars($complaint['complainedMotherOccupation'])); ?></u>
                    </p>
                </td>
            </tr>
            <tr>
                <td>
                    <p style="margin-left: 65px;"> Address: <u><?php echo ucwords(htmlspecialchars($complaint['complainedMotherAddress'])); ?></u>
                        </u>
                    </p>
                </td>
            </tr>
            <tr>
                <td>
                    <p style="margin-left: 65px;"> Contact Number: <u><?php echo htmlspecialchars($complaint['complainedMotherContact']); ?></u>
                        </u>
                    </p>
                </td>
            </tr>
        ...
        <table class="table-form mt-2">
            <tr>
                <td>
                    <p style="margin-left: 65px;"> Father: <u><?php echo ucwords(htmlspecialchars($complaint['complainedFatherName'])); ?></u>
                    </p>
                </td>
            </tr>
            <tr>
                <td>
                    <p style="margin-left: 65px;"> Occupation: <u><?php echo ucwords(htmlspecialchars($complaint['complainedFatherOccupation'])); ?></u>
                        </u>
                    </p>
                </td>
            </tr>
            <tr>
                <td>
                    <p style="margin-left: 65px;"> Address: <u><?php echo ucwords(htmlspecialchars($complaint['complainedFatherAddress'])); ?></u>
                        </u>
                        </u>
                    </p>
                </td>
            ...
            <tr>
                <td>
                    <p style="margin-left: 65px;"> Contact Number: <u><?php echo htmlspecialchars($complaint['complainedFatherContact']); ?></u>
                        </u>
                        </u>
                    </p>
                </td>
