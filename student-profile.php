            ...
            <div class="card border-secondary mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <strong>Name:</strong>
                            <input type="text" class="form-control" value="<?php echo ucwords(htmlspecialchars($mother['name'])) ?: 'N/A'; ?>" readonly>
                        </div>
                        <div class="col-md-4">
                            <strong>Contact Number:</strong>
                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($mother['contact_number']) ?: 'N/A'; ?>" readonly>
                        </div>
                        <div class="col-md-4">
                            <strong>Email:</strong>
                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($mother['email']) ?: 'N/A'; ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <strong>Name:</strong>
                            <input type="text" class="form-control" value="<?php echo ucwords(htmlspecialchars($father['name'])) ?: 'N/A'; ?>" readonly>
                        </div>
                        <div class="col-md-4">
                            <strong>Contact Number:</strong>
                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($father['contact_number']) ?: 'N/A'; ?>" readonly>
                        </div>
                        <div class="col-md-4">
                            <strong>Email:</strong>
                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($father['email']) ?: 'N/A'; ?>" readonly>
                        </div>
                    </div>
                </div>
            </div>
